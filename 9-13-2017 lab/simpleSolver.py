...
# tests should always go in a seperate file, if not just for organizational purposes. Nonetheless, 
# here I am putting the tests in the same file (stop requiring it! Python has an import command for a reason)
